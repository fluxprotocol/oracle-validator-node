...
describe('DataRequest', () => {
    describe('currentRound', () => {
        it('should always return the latest round', () => {
            ...
            expect(request.currentRound.round).toBe(1);
        });
    });
    ...
    describe('update', () => {
        it('should update the rounds when given a new datarequest', () => {
            ...
            expect(request.rounds[0].winningOutcome).toBe('test');
            expect(request.rounds.length).toBe(2);
        });
    });
    ...
    describe('isClaimable', () => {
        ...
        it('should be claimable when the current date exceeds the quorom date', () => {
            const request = createMockRequest({
                rounds: [{
                    outcomeStakes: {},
                    quoromDate: '1900-03-29T12:30:00.939Z',
                    round: 0
                }],
            });
